...
<head>
    ...
    <meta name="author" content="From KALVIN Team">
...
<div class="container">
    ...
    <div class="page-header">
        <h1 style="color:black">Crop Suggestion System TOOL For Farmers</h1>
  ...
  .</p>
     ...
     <br><br>
    <div class="page-header">
        <h1 style="color:black">FARMER'S INFORMATION</h1>
        <div class="row">
        <div class="col-md-8">
            <p><h4 style="color: black">Farmers Can help us By providing information about your Agriculture Statastics. This data may help in future for Agricultre .you can provide statastical data by <strong>Signup or Sign in .  </strong></h4>
            </p>
          ...
          <center>
           ...
           <button class="button" onclick="window.location.href='<?php echo $link2; ?>'" style="width:auto;">Login</button>
            ...
            <footer class="footer">
           <div class="container">
           <p align =right  style="color: white" size="24" > Built by <strong>"KALVIN "</strong> & team .</p>
           </div>
